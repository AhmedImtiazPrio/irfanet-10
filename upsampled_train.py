...
if __name__ == '__main__':
	...
	mdlchk=ModelCheckpoint(filepath='/home/prio/Keras/thesis/irfanet-10/tmp/1DCNN_221017/weights.{epoch:02d}-{val_acc:.4f}.hdf5',monitor='val_acc',save_best_only=False,mode='max')
